    ...
    Route::group(['prefix' => 'app'], function() {
        Route::group(['prefix' => 'admin', 'middleware' => ['web', 'auth', 'role:admin']], function() {
            ...
            Route::controller(DavinciConfigController::class)->group(function() {
                ...
                Route::get('/davinci/configs/costs', 'showCosts')->name('admin.davinci.configs.costs');
                Route::post('/davinci/configs/costs/store', 'storeCosts')->name('admin.davinci.configs.costs.store');
            ...
            Route::controller(GlobalController::class)->group(function() {
                ...
                Route::get('/settings/about', 'about')->name('admin.settings.about');
            });
