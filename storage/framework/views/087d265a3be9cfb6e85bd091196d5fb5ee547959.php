				...
				<div class="card-body">
					<div>
						...
						<?php if(config('settings.custom_templates') == 'anyone'): ?>
							<a href="<?php echo e(route('user.templates.custom')); ?>" class="btn btn-primary ripple" id="create-ai-button" style="text-transform: none;"><?php echo e(__('Create Custom Template')); ?></a>
						<?php else: ?>
							<?php if($check): ?>
								<a href="<?php echo e(route('user.templates.custom')); ?>" class="btn btn-primary ripple" id="create-ai-button" style="text-transform: none;"><?php echo e(__('Create Custom Template')); ?></a>
							<?php endif; ?>	
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aihowgkq/protagoras.app/resources/views/user/templates/index.blade.php ENDPATH**/ ?>