    ...
    <div class="container-fluid"> 
        <div class="d-flex">            
            ...
            <div class="" id="balance">
                <span class="fs-11 text-muted"><i class="fa-sharp fa-solid fa-bolt-lightning mr-2 text-primary"></i><?php echo e(__('You have')); ?> <span class="font-weight-semibold text-white" id="balance-number"><?php if(auth()->user()->gpt_3_turbo_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format(auth()->user()->gpt_3_turbo_credits + auth()->user()->gpt_3_turbo_credits_prepaid)); ?><?php endif; ?></span> <?php echo e(__('words')); ?></span>
            </div> 
...
<!-- END TOP MENU BAR -->
<?php /**PATH /home/aihowgkq/protagoras.app/resources/views/layouts/nav-top-smart.blade.php ENDPATH**/ ?>