	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#listPaymentsTable').DataTable({
				...
				"order": [[ 6, "desc" ]],
				language: {
					"emptyTable": "<div><br><?php echo e(__('There are no transactions yet')); ?></div>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aihowgkq/protagoras.app/resources/views/admin/finance/transactions/index.blade.php ENDPATH**/ ?>