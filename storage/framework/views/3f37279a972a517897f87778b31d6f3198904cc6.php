					...
					<table id='subscriptionPlanTable' class='table' width='100%'>
							<thead>
								<tr>
									...
									<th width="2%"><?php echo e(__('Subscribers')); ?></th>
									<th width="22%"><?php echo e(__('GPT 4 / GPT 4T / GPT 3.5T')); ?> / <?php echo e(__('DE Images')); ?> / <?php echo e(__('SD Images')); ?> / <?php echo e(__('Characters')); ?> / <?php echo e(__('Minutes')); ?></th>																									
									<th width="3%"><?php echo e(__('Frequency')); ?></th>																		
									<th width="2%"><?php echo e(__('Featured')); ?></th>
									<th width="2%"><?php echo e(__('Free')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aihowgkq/protagoras.app/resources/views/admin/finance/plans/index.blade.php ENDPATH**/ ?>