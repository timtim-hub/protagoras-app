						...
						<div class="col-lg-8 col-md-8 col-sm-12">
							<div class="row text-center">
								<div class="col-lg col-md-6 col-sm-6">
									<h6 class="fs-12 mt-3 font-weight-bold"><?php echo e(__('GPT 3.5 Turbo ')); ?> <?php echo e(__('Words Left')); ?></h6>
				...
				<div class="card border-0" id="user-dashboard-panels">
					<div class="card-header pt-4 pb-4 border-0">
						<div class="mt-3">
							...
							<h6 class="text-muted"><?php echo e(__('Have your favorite AI chat assistants handy anytime you need them')); ?></h6>
						</div>
					</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aihowgkq/protagoras.app/resources/views/user/dashboard/index.blade.php ENDPATH**/ ?>