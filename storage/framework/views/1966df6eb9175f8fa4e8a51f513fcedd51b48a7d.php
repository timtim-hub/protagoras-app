	...
	<div class="page-header mt-5-7">
		...
		<div class="page-rightheader">
			<div id="balance-status">
				<span class="fs-11 text-muted pl-3"><i class="fa-sharp fa-solid fa-bolt-lightning mr-2 text-primary"></i><?php echo e(__('Your Balance is')); ?> <span class="font-weight-semibold" id="balance-number"><?php if(auth()->user()->gpt_3_turbo_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format(auth()->user()->gpt_3_turbo_credits + auth()->user()->gpt_3_turbo_credits_prepaid)); ?> <?php endif; ?> <?php echo e(__('GPT 3.5 Turbo')); ?> <?php echo e(__('Words')); ?></span></span>
			</div>
		</div>
	</div>
	<!-- END PAGE HEADER -->
								...
								<div class="flex" id="templates-panel">			
									<div class="row chat-model-box pl-5 pr-5 pt-2 pb-2">
										...
										<div class="col-md-4 col-sm-12">
											<input type="radio" id="control_01" name="model" onclick="handleClick(this);" value="gpt-3.5-turbo-0125" <?php if($default_model == 'gpt-3.5-turbo-0125'): ?> checked <?php endif; ?>>
										...
										<?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											...
											<?php if(trim($model) == 'gpt-4'): ?>
												<div class="col-md-4 col-sm-12">
													<input type="radio" id="control_02" name="model" onclick="handleClick(this);" value="gpt-4" <?php if($default_model == 'gpt-4'): ?> checked <?php endif; ?>>												
											...
											<?php elseif(trim($model) == 'gpt-4-0125-preview'): ?>
												<div class="col-md-4 col-sm-12">
													<input type="radio" id="control_03" name="model" onclick="handleClick(this);" value="gpt-4-0125-preview" <?php if($default_model == 'gpt-4-0125-preview'): ?> checked <?php endif; ?>>
											...
											<?php elseif(trim($model) == 'gpt-4-turbo-2024-04-09'): ?>
												<div class="col-md-4 col-sm-12">
													<input type="radio" id="control_04" name="model" onclick="handleClick(this);" value="gpt-4-turbo-2024-04-09" <?php if($default_model == 'gpt-4-turbo-2024-04-09'): ?> checked <?php endif; ?>>
											...
											<?php elseif(trim($model) == 'claude-3-opus-20240229'): ?>
												<div class="col-md-4 col-sm-12">
													<input type="radio" id="control_05" name="model" onclick="handleClick(this);" value="claude-3-opus-20240229" <?php if($default_model == 'claude-3-opus-20240229'): ?> checked <?php endif; ?>>
											...
											<?php elseif(trim($model) == 'claude-3-sonnet-20240229'): ?>
												<div class="col-md-4 col-sm-12">
													<input type="radio" id="control_06" name="model" onclick="handleClick(this);" value="claude-3-sonnet-20240229" <?php if($default_model == 'claude-3-sonnet-20240229'): ?> checked <?php endif; ?>>
													<label for="control_06">
														<h6>
															<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" class="mr-1 inline-block h-4 w-4 align-text-top" aria-hidden="true"><path fill="currentColor" fill-rule="evenodd" d="M3.512 6.065c-.777 1.87-1.772 4.262-2.212 5.317l-.8 1.92 1.229.017c.676.01 1.24.006 1.255-.008.015-.014.221-.505.459-1.09l.431-1.066h4.718l.117.293.44 1.089.321.797h1.258c.98 0 1.25-.018 1.224-.082a3382.243 3382.243 0 0 1-3.78-9.073l-.625-1.512H4.924L3.512 6.065ZM9.68 2.788c.018.066 1.007 2.466 2.198 5.332l2.165 5.213h1.244c.684 0 1.23-.021 1.213-.048-.047-.074-4.3-10.303-4.354-10.472-.047-.144-.061-.146-1.274-.146-1.16 0-1.224.006-1.192.12ZM6.576 6.195c.178.439.515 1.265.75 1.838l.425 1.04-.739.019c-.406.01-1.089.01-1.517 0l-.78-.019.358-.878.748-1.837c.215-.528.4-.96.41-.96.012 0 .167.36.345.797Z" clip-rule="evenodd"></path></svg>
															<?php echo e(__('Claude 3 Sonnet')); ?>
											...
											<?php elseif(trim($model) == 'claude-3-haiku-20240307'): ?>
												<div class="col-md-4 col-sm-12">
													<input type="radio" id="control_07" name="model" onclick="handleClick(this);" value="claude-3-haiku-20240307" <?php if($default_model == 'claude-3-haiku-20240307'): ?> checked <?php endif; ?>>
												...
												<div class="col-md-4 col-sm-12">
													<input type="radio" id="control_08" name="model" onclick="handleClick(this);" value="gemini_pro" <?php if($default_model == 'gemini_pro'): ?> checked <?php endif; ?>>
											...
											<?php else: ?>
												<?php $__currentLoopData = $fine_tunes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$fine_tune): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<?php if(trim($model) == $fine_tune): ?>
														<div class="col-md-4 col-sm-12">
															<input type="radio" id="control_<?php echo e($key); ?>_f" name="model" onclick="handleClick(this);" value="<?php echo e($fine_tune->model); ?>" <?php if($default_model == $fine_tune->model): ?> checked <?php endif; ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aihowgkq/protagoras.app/resources/views/user/chat/view.blade.php ENDPATH**/ ?>