		...
		<div class="row no-gutters justify-content-center">
			<div class="col-lg-9 col-md-11 col-sm-12 text-center">
				...
				<div class="card-bottom p-0">
					<a class="prompts text-muted fs-11 font-weight-semibold" href="#" data-bs-toggle="modal" data-bs-target="#promptModal" data-tippy-content="<?php echo e(__('Prompt Library')); ?>"><?php echo e(__('Prompts')); ?></a>
				</div>
					...
					<select id="resolution" name="resolution_sd" class="form-select sd-feature hide-all">	
						<?php if($sd_model == 'none'): ?>
							...
							<?php elseif(config('settings.image_stable_diffusion_engine') == 'stable-diffusion-xl-1024-v1-0'): ?>
								...
								<option value='768x1344'>768 x 1344px</option>
								<option value='640x1536'>640 x 1536px</option>
							<?php elseif(config('settings.image_stable_diffusion_engine') == 'sd3' || config('settings.image_stable_diffusion_engine') == 'sd3-turbo' || config('settings.image_stable_diffusion_engine') == 'core'): ?>
								<option value='1:1'>1:1 (<?php echo e(__('Aspect Ratio')); ?>)</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aihowgkq/protagoras.app/resources/views/user/images/index.blade.php ENDPATH**/ ?>